...
ratios_casa_grande = analizar_empresa(casa_grande_root, id_casa_grande_2024,"Casa Grande")
ratios_cartavio = analizar_empresa(cartavio_root,id_cartavio_2024 ,"Cartavio")
